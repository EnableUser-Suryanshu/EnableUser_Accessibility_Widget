...
//
// Soft 64 MB byte cap matches pdf-audit.js — Office docs in the wild very
// rarely exceed that, and pulling a 500 MB scan-export PPTX into a tab's
// memory would cause more problems than the audit is worth.

const SOFT_MAX_BYTES = 64 * 1024 * 1024;
...
// No ZIP64, no encryption, no multi-volume — OOXML writers never emit
// these for docs under 4 GiB and we soft-cap at 64 MB anyway.
// ─────────────────────────────────────────────────────────────────────────
