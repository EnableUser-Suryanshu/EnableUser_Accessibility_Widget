...
import { MANUAL_TESTS, MANUAL_CHECKLIST_VERSION, testApplicability } from "./manual-checklist.js";
...
const MANUAL_HEADERS = ["Test ID", "Pass", "SC", "Level", "What to verify", "How to test", "Pass criterion", "Why scanners miss it", "Applies To", "Sample URLs to test", "Result", "Notes"];
const MANUAL_WIDTHS = [8, 22, 8, 6, 40, 55, 45, 45, 30, 55, 10, 30];
