...
function buildPagesSheet(inventory) {
  ...
  for (const p of inventory.pages) {
    ...
    rows.push([
      ...
      c.forms, c.inputs, c.requiredInputs, c.fileInputs, c.passwordInputs, c.otpInputs,
      c.dataTables, c.videos, c.audios, c.youtube, c.vimeo, f.hasCaptions ? "Yes" : "No",
      c.iframes, c.embeds, c.svgs,
      c.modals, c.carousels, c.tabs, c.menus, c.accordions, c.tooltips, c.datepickers, c.dropdowns,
      c.navs, c.mainLandmarks, c.skipLinks, c.breadcrumbs,
      c.pdfLinks, c.docLinks, c.externalLinks,
      c.images, c.imagesNoAlt, c.decorativeImages, c.bgImages,
      c.elemsWithLang, c.shadowRoots,
      c.h1, c.h2, c.h3, c.h4, c.h5, c.h6, c.headingSkips,
...
function buildTemplatesSheet(inventory) {
  const rows = [[
    "Template ID", "URL Cluster", "Page Count", "Sample URL",
