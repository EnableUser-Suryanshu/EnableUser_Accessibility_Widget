...
(function () {
  ...
  function nodeFor(el, failure) {
    const html = (el.outerHTML || "").slice(0, 10000); // keep full but cap runaway blobs
    return {
      html,
  ...
  function checkPageScriptLangMismatch() {
    ...
    return {
      ...
      impact: "serious",
      tags: ["wcag311", "is17802", "gigw3", "india-language", "wcag2a", "wcag21aa"],
      ...
      help: `Set <html lang="..."> to match the dominant script. IS 17802 / GIGW require the page language to be programmatically determinable (WCAG 3.1.1).`,
  ...
  function checkPassageLangMismatch() {
    ...
    return {
      ...
      impact: "moderate",
      tags: ["wcag312", "is17802", "gigw3", "india-language", "wcag21aa"],
      ...
      nodes: out.slice(0, 200).map(({ el, script, lang, chars }) =>
  ...
  function checkRtlDirection() {
    ...
    return {
      ...
      impact: "serious",
      tags: ["wcag134", "is17802", "gigw3", "india-language", "wcag21aa"],
      ...
      nodes: out.slice(0, 100).map(({ el, script, dir }) =>
  ...
  function checkFontCoverage() {
    ...
    return {
      ...
      impact: "minor",
      tags: ["wcag141", "is17802", "gigw3", "india-language", "review"],
      ...
      nodes: out.slice(0, 100).map(({ el, family }) =>
