...
// Block list philosophy (v6): the crawler is a discovery tool — it should
// find every URL a human could reach by clicking links. Only block URLs
// that a human CANNOT click through to:
...
//
// Everything else stays in — including /author, /tag, /category, /attachment,
// /feed, /page/<N> pagination, and CPT taxonomy archives. These may look
// like "auto-generated chaff" in a sitemap, but if the site template
// links to them (blog sidebar, "browse by tag" widget, pagination chevrons,
// post author bylines), a human CAN click through to them and therefore
// the audit scope should include them. A permissive discovery pass feeds
// an honest inventory; tightening the list of URLs to actually audit is
// a separate, report-level decision.
