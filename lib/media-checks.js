...
//   • Same links missing a file-type / size hint — WCAG G189 advisory.
    ...
    for (const d of items) {
      ...
      if (!d.hasTypeHint) {
        ...
        rules.push(rule("media-doc-type-hint", {
          ...
          help: `Include "${d.typeLabel}" (or a recognisable extension like ".${d.subtype}") in the link text, aria-label, or visible icon label. WCAG Techniques advisory G189 recommends declaring non-HTML formats so users know what will open.`,
          helpUrl: "https://www.w3.org/WAI/WCAG21/Techniques/general/G189",
          wcagTags: ["wcag244", "advisory"],
          el: d.element,
      ...
      if (!d.hasSizeHint) {
        ...
        rules.push(rule("media-doc-size-hint", {
          ...
          help: "Include a size indicator such as \"(2.3 MB)\" so users on metered connections or assistive tech users can decide whether to open. Advisory under WCAG G189.",
          helpUrl: "https://www.w3.org/WAI/WCAG21/Techniques/general/G189",
          wcagTags: ["advisory"],
          el: d.element,
