...
const CRITERION_MAP = {
  ...
  "wcag2411": { num: "2.4.11", level: "AA", name: "Focus Not Obscured (Minimum)" },
  ...
  "wcag257": { num: "2.5.7", level: "AA", name: "Dragging Movements" },
  "wcag258": { num: "2.5.8", level: "AA", name: "Target Size (Minimum)" },
  ...
  "wcag326": { num: "3.2.6", level: "A", name: "Consistent Help" },
  ...
  "wcag337": { num: "3.3.7", level: "A", name: "Redundant Entry" },
  "wcag338": { num: "3.3.8", level: "AA", name: "Accessible Authentication (Minimum)" },
...
// SC-number → {num, level, name} lookup, so callers can build a criterion
// list from an arbitrary set of SC numbers (e.g. a profile/version-specific
// scope chosen at scan time). Used by background.js buildReport.
export const CRITERION_BY_NUM = Object.fromEntries(
  Object.values(CRITERION_MAP).map(c => [c.num, c])
);
