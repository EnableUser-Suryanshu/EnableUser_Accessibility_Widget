...
function buildDocumentXml(inventory) {
  ...
  parts.push(paragraph(
    `Automated audit roll-up (axe-core 4.11.3 + IS 17802 custom checks, executed live against every crawled page): ` +
  ...
  if (selectedProfile === "is17802") {
    ...
    parts.push(paragraph("• Chapter 9 (Web content) — full automated pass via axe-core 4.11.3 mapped to WCAG 2.1 A+AA, which IS 17802 Ch 9 mirrors directly.", { size: 22 }));
